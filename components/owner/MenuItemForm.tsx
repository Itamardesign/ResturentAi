...
import { translateContent, generateDescription, analyzeImageForEnhancement, fileToGenerativePart } from '../../services/geminiService';
                ...
                <div className="flex flex-wrap gap-3">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl border font-medium transition-all ${
                            currentTags.includes("Recommended")
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl border font-medium transition-all ${
                            currentTags.includes("Chef's Choice")
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl border font-medium transition-all ${
                            currentTags.includes("Best Seller")
                        ...
                        {(['none', 'mild', 'medium', 'hot'] as SpicinessLevel[]).map((level) => (
                            <button
                                ...
                                className={`flex-1 py-2 px-3 rounded-lg border text-sm font-medium transition-all flex items-center justify-center gap-2 ${
                                    currentDietary.spiciness === level 
